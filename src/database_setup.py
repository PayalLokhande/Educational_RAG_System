...
DB_NAME = "data/SQLite Database Files/technical_questions.db"
JSON_SRC = "data/JSON data files/cleaned_technical_questions.json"
...
DB_NAME = "data/SQLite Database Files/viva_questions.db"
JSON_SRC = "data/JSON data files/cleaned_viva_questions.json"
